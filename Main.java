	...
	public static void main(String[] args) {
		...
		do {
            ...
            case "6":
            	...
            	{
	            	if (telefono.getScheda()==null) {
	            		// MODIFICA: controllo che esista una SIM creata prima di inserirla
	            		if (scheda == null) {
	            			System.out.println("Nessuna SIM creata. Crea prima una SIM (opzione 1).");
	            		} else {
            ...
            case "13":
            	...
            	{
            		if (televisore.getCanali().isEmpty()) { // MODIFICA: avvisa se non sintonizzata
            			System.out.println("Nessun canale sintonizzato. Esegui opzione 12 per sintonizzare la TV.");
            			break;
            		}
            		//inserisco il canale
            		int canale=0;
